...
namespace Factura
{
    class ClsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = " ARTICULO      CANTIDAD   PRECIO    TOTAL";   // agrega lineas de  encabezados
                line.AppendLine(LineEncavesado);

            }

            public static void EncabezadoVen2a()
            {
                string LineEncavesado = " ";   // agrega lineas de  encabezados
                line.AppendLine(LineEncavesado);
