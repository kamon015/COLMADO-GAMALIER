...
namespace colmado1
{
            ...
            List<string> nombresArticulos = new List<string>
    {
        ...
        // MEtodo para calcular y mostrar el subtotal y total en el textBox9  
        private void CalcularSubtotalYTotal()
        {
            ...
            double totalITBIS = subtotal * 0.25; 
        ...
        {
            // Configurar columnas para el DataGridView1 que es el inventario
            // Configurar columnas para el DataGridView2 (carrito o lista )
        }
